...
// Color picker popup component - extracted from LayerTree for reuse
...
export function ColorPickerPopup({ color, position, onColorChange, onClose, initialMode = 'fill', initialStrokeWidth = '1' }: ColorPickerPopupProps) {
